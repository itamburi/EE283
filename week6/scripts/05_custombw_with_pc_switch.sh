...
samtools view -b ${out}/A4ED_sorted.bam | genomeCoverageBed -pc -ibam - -g ${ref}/dm6.fasta -bg -scale $Scale > ${out}/A4ED.coverage_pc
# these are the so called "kent-tools", useful for converting between various file types
bedGraphToBigWig ${out}/A4ED.coverage_pc $chromsizes ${out}/A4ED_pc.bw
