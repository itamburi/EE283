...
#SBATCH --array=1-12 		# there are 384 samples but we only need to do a few for the hw 
#SBATCH --mem-per-cpu=4G
#SBATCH --output=/dfs6/pub/itamburi/ee283/week3/prob5/RNAlog/%J.log   # Output and error log 
